...
namespace WebThoiTrang.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MASP,MALOHANG,TENSANPHAM,ANHSP,GIATIEN,THUONGHIEU,MANPP,SIZE,NGAYTRAVE,VAT,MAU,SOLUONG,MOTA")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MASP,MALOHANG,TENSANPHAM,ANHSP,GIATIEN,THUONGHIEU,MANPP,SIZE,NGAYTRAVE,VAT,MAU,SOLUONG,MOTA")] Product product)
        {
            if (ModelState.IsValid)
            {
